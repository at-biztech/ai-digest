...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="page">
        <div className="topline"><div className="topline-title">DAILY AI NEWS</div><div className="topline-desc">News that affects how we build. Updated every morning.</div></div>
